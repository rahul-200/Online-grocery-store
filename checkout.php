...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    foreach ($products as $i => $product) {
        echo "<div style='border: 1px solid #ccc; border-radius: 5px; padding: 10px; margin-bottom: 10px;'>";
        echo "<div>"; // Product details container
        echo "<p style='margin: 0;'><strong>Product Name:</strong> " . $product['name'] . "</p>"; // Product Name
        echo "<p style='margin: 0;'><strong>Quantity:</strong> " . $product['quantity'] . "</p>"; // Quantity
        echo "<p style='margin: 0;'><strong>Subtotal:</strong> " . $product['subtotal'] . "</p>"; // Subtotal
    ...
    echo "<h4 style='text-align: center;'>Total Amount Paid: " . $total . "</h4>";
    echo "<h4 style='text-align: center; color: #007bff; font-size: 20px; font-weight: bold;'>Your Order will be delivered tomorrow</h4>";
}
?>
